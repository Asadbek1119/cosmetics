...
namespace common\modules\profilemanager\controllers;

use common\modules\profilemanager\models\ChangePasswordForm;
use common\modules\profilemanager\models\ProfileUser;
use Yii;
